...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*CAInjectorControllerConfig)(nil), (*config.CAInjectorControllerConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CAInjectorControllerConfig_To_config_CAInjectorControllerConfig(a.(*CAInjectorControllerConfig), b.(*config.CAInjectorControllerConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.CAInjectorControllerConfig)(nil), (*CAInjectorControllerConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_CAInjectorControllerConfig_To_v1alpha1_CAInjectorControllerConfig(a.(*config.CAInjectorControllerConfig), b.(*CAInjectorControllerConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_CAInjectorControllerConfig_To_config_CAInjectorControllerConfig(in *CAInjectorControllerConfig, out *config.CAInjectorControllerConfig, s conversion.Scope) error {
	out.Enabled = (*bool)(unsafe.Pointer(in.Enabled))
	out.ConcurrentSyncs = (*int)(unsafe.Pointer(in.ConcurrentSyncs))
	return nil
}

// Convert_v1alpha1_CAInjectorControllerConfig_To_config_CAInjectorControllerConfig is an autogenerated conversion function.
func Convert_v1alpha1_CAInjectorControllerConfig_To_config_CAInjectorControllerConfig(in *CAInjectorControllerConfig, out *config.CAInjectorControllerConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_CAInjectorControllerConfig_To_config_CAInjectorControllerConfig(in, out, s)
}

func autoConvert_config_CAInjectorControllerConfig_To_v1alpha1_CAInjectorControllerConfig(in *config.CAInjectorControllerConfig, out *CAInjectorControllerConfig, s conversion.Scope) error {
	out.Enabled = (*bool)(unsafe.Pointer(in.Enabled))
	out.ConcurrentSyncs = (*int)(unsafe.Pointer(in.ConcurrentSyncs))
	return nil
}

// Convert_config_CAInjectorControllerConfig_To_v1alpha1_CAInjectorControllerConfig is an autogenerated conversion function.
func Convert_config_CAInjectorControllerConfig_To_v1alpha1_CAInjectorControllerConfig(in *config.CAInjectorControllerConfig, out *CAInjectorControllerConfig, s conversion.Scope) error {
	return autoConvert_config_CAInjectorControllerConfig_To_v1alpha1_CAInjectorControllerConfig(in, out, s)
}
...
func autoConvert_v1alpha1_ControllerConfiguration_To_config_ControllerConfiguration(in *ControllerConfiguration, out *config.ControllerConfiguration, s conversion.Scope) error {
	...
	if err := Convert_v1alpha1_CAInjectorControllerConfig_To_config_CAInjectorControllerConfig(&in.CAInjector, &out.CAInjector, s); err != nil {
		return err
	}
	return nil
}
...
func autoConvert_config_ControllerConfiguration_To_v1alpha1_ControllerConfiguration(in *config.ControllerConfiguration, out *ControllerConfiguration, s conversion.Scope) error {
	...
	if err := Convert_config_CAInjectorControllerConfig_To_v1alpha1_CAInjectorControllerConfig(&in.CAInjector, &out.CAInjector, s); err != nil {
		return err
	}
	return nil
}
