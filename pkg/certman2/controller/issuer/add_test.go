...
var _ = Describe("Add", func() {
	Describe("#Predicate", func() {
		var (
			...
			issuerNew       *v1alpha1.Issuer

			test func(*v1alpha1.Issuer, *v1alpha1.Issuer, types.GomegaMatcher, types.GomegaMatcher)
		)
		...
		It("should handle objects whose last operation is not successful", func() {
			issuer.Status = v1alpha1.IssuerStatus{
			...
			issuerNew.Status = v1alpha1.IssuerStatus{
				/*				LastOperation: &gardencorev1beta1.LastOperation{
									State:       "Progressing",
									Description: "Step A",
									Progress:    10,
