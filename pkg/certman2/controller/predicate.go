...
// CertClassPredicate returns a predicate that filters objects by their class.
func CertClassPredicate(expectedClass string) predicate.Predicate {
	return FilterPredicate(func(obj client.Object) bool {
		class := obj.GetAnnotations()[core.AnnotationClass]
		if class == "" {
