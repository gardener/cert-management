...
var issuersResource = schema.GroupVersionResource{Group: "cert", Version: "v1alpha1", Resource: "issuers"}

var issuersKind = schema.GroupVersionKind{Group: "cert", Version: "v1alpha1", Kind: "Issuer"}
