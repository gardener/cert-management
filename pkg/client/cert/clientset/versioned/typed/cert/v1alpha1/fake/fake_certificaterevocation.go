...
var certificaterevocationsResource = v1alpha1.SchemeGroupVersion.WithResource("certificaterevocations")

var certificaterevocationsKind = v1alpha1.SchemeGroupVersion.WithKind("CertificateRevocation")
