...
func (c *issuers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Issuer, err error) {
...
func (c *issuers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IssuerList, err error) {
...
func (c *issuers) Create(ctx context.Context, issuer *v1alpha1.Issuer, opts v1.CreateOptions) (result *v1alpha1.Issuer, err error) {
	result = &v1alpha1.Issuer{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("issuers").
...
func (c *issuers) Update(ctx context.Context, issuer *v1alpha1.Issuer, opts v1.UpdateOptions) (result *v1alpha1.Issuer, err error) {
	result = &v1alpha1.Issuer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("issuers").
...
func (c *issuers) UpdateStatus(ctx context.Context, issuer *v1alpha1.Issuer, opts v1.UpdateOptions) (result *v1alpha1.Issuer, err error) {
	result = &v1alpha1.Issuer{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("issuers").
...
func (c *issuers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Issuer, err error) {
	result = &v1alpha1.Issuer{}
