...
import (
	...
	cert "github.com/gardener/cert-management/pkg/client/cert/informers/externalversions/cert"
...
func (f *sharedInformerFactory) Cert() cert.Interface {
	return cert.New(f, f.namespace, f.tweakListOptions)
}
